...
<body>
	<div class="container">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-heading">修改资讯文章</div>
			<div class="panel-body"></div>
			<form class="form-horizontal" action="/admin/zx/update" method="post"
				enctype="multipart/form-data" id="zixunForm">
				
				<input id="nid" name="nid" value="${zixun.nid}" type="hidden">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-xs-8">
							<input id="title" name="title" type="text" value="${zixun.title }"
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-xs-8">
							<input id="author" name="author" type="text" value="${zixun.author }"
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-xs-8">
							<select id="caipiaoType" name="caipiaoType" class="form-control">
								<option value="${zixun.caipiaoType }">--请选择--</option>
					...
					<div class="form-group">
						...
						<div class="col-md-7 col-xs-7">
							<textarea rows="10"  class="form-control" id="summary" name="summary"><c:out value="${zixun.summary }"></c:out></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-7 col-xs-7">
							<textarea  rows="20" cols="100" class="form-control" id="content" name="content"><c:out value="${zixun.content }"></c:out></textarea>
						</div>
					</div>
